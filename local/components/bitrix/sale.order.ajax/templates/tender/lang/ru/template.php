...
$MESS["SOA_ORDER_SUC1"] = "Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\">Списке заказов</a>. Обратите внимание, что для этого вам необходимо будет авторизироваться.";
